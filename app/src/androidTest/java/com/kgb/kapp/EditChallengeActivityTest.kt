...
import com.kgb.kapp.repository.MockChallengeRepository
...
class EditChallengeActivityTest {
    ...
    fun checkDataSetToDefaultValueForNewChallenge() {
        ...
        onView(withId(R.id.challenge_name))
                .check(matches(isDisplayed()))
                .check(matches(withSpinnerSelectedItem(InstrumentationRegistry.getTargetContext().getString(defaultChallengeType.challengeResId))))
    ...
    fun checkCorrectDataWhenChallengeEdited() {
        ...
        onView(withId(R.id.challenge_name))
                .check(matches(isDisplayed()))
                .check(matches(withSpinnerSelectedItem(InstrumentationRegistry.getTargetContext().getString(testChallenge.challengeName.challengeResId))))
